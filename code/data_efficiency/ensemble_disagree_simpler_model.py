...
def identify_disagreement_instances(train_data):
    ...
    individual_preds = np.vstack([pred_clf1, pred_clf2, pred_clf3])
    ...
    disagreement_indices = np.where(disagreements == 1)[0]
...
if __name__ == "__main__":
    ...
    ensemble_model_simple.ensemble_learning(filtered_train_data, dev_data=data_loader.load_dev_encode_pre(encoder))
