...
def ensemble_learning(train_data, dev_data):
    ...
    # Plot learning curve
    learning_curve.plot_learning_curve_cv(ensemble_model, train_data, "Learning Curve for Ensemble Model (5 base classifiers & not tuned)")
    ...
    model_filename = '../test/ensemble_model_simple.pkl'
